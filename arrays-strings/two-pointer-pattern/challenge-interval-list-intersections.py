"""
Dadas dos listas de intervalos cerrados, lista1 y lista2,
donde lista1[i] = [inicio_i, final_i] y lista2[j] = [inicio_j, final_j].
...
Entrada: firstList = [[0,2],[5,10],[13,23],[24,25]], secondList = [[1,5],[8,12],[15,24],[25,26]]
Salida: [[1,2],[5,5],[8,10],[15,23],[24,24],[25,25]]

Ejemplo 2:

Entrada: firstList = [[1,3],[5,9]], secondList = []
Salida: []
"""
